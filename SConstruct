...
opts.Add(PathVariable("target_name", "The library name.", "libscreengrab", PathVariable.PathAccept))
...
if platform == "osx":
    ...
    env.Append(LINKFLAGS=["-lX11", "-lGL", "-lXtst", "-lxcb", "-lxcb-composite", "-lX11-xcb", "-Wl,--no-undefined", "-Wl,--as-needed"])
